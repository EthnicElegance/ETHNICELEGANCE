        ...
        child: StreamBuilder(
            ...
            builder: (BuildContext context, AsyncSnapshot<dynamic> snapshot) {
              if (snapshot.hasData) {
                ...
                map.forEach((dynamic, v) => prodlist.add(ProductModel(
                    dynamic.toString(),
                    v["subcatid"],
                    v["product_name"],
                    v["photo1"],
                ...
                return GridView.builder(
                  ...
                  itemBuilder: (BuildContext context, int index) {
                    // print(prodlist[index].subcatid == widget.productSubCat.toString());
                    // if (prodlist[index].subcatid == widget.productSubCat.toString()) {
