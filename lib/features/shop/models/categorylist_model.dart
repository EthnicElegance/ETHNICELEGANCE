...
class ECategoryList extends StatelessWidget {
  const ECategoryList({super.key, this.limitedCategory=false, this.categoryCount});
  ...
  Widget build(BuildContext context) {
    ...
    return Padding(
        ...
        child: SizedBox(
          child: StreamBuilder(
              stream: FirebaseDatabase.instance.ref().child("Project/category").onValue,
                              ...
                              Flexible(
                                  child: Container(
                                    ...
                                    child: Center(
                                        child: Image(
                                          fit: BoxFit.contain,
                                          image: NetworkImage("https://firebasestorage.googleapis.com/v0/b/ethnicelegance-71357.appspot.com/o/CategoryImage%2F${catlist[index].cphoto}?alt=media"),
