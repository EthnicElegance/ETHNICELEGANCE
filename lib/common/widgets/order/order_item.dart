...
class EOrderItem extends StatefulWidget {
  const EOrderItem({super.key, required this.id, this.index, required this.orderId});
  ...
  @override
  State<EOrderItem> createState() => _EOrderItemState();
}

class _EOrderItemState extends State<EOrderItem> {
  String? userid;
  late Query dbRef;
